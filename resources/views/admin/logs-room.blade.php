    ...
    <body class="sb-nav-fixed p-2">
            ...
            <div id="layoutSidenav_content">
                <main class="shadow rounded p-3">
                    <div class="container-fluid row">
                        <div class="col-xl-12">
                            <h1 class="mt-4">Room Logs</h1>
                            <ol class="breadcrumb mb-4">
                                <li class="breadcrumb-item active">Monitor User activity logs in room.</li>
                            </ol>
                        </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                var logs_room = $('#usersLog').DataTable({
                    order: [[6, 'desc']],
                    dom: 'Bfrtip',
                    buttons: [
                        {
                ...
                $("#inp_date").on("change", function() {
                    ...
                    logs_room.clear().draw();
                    logs.forEach(function (item) {
                        if(date == item.time_in.substr(0,10)){
                            logs_room.row.add($("<tr><small><td>" + item.type + "</td></small><small><td>" + item.card_id + "</td></small><small><td>"+ item.identity_number +"</td></small><small><td>"+ item.name +"</td></small><small><td>"+ item.location +"</td><small><td>"+ item.section +"</td></small></small><small><td>"+ item.time_in +"</td></small><small><td>"+ item.time_out + "</td></small></tr>")).draw(false);
                        }
                    });
                });
                $("#inp_date").trigger("change");
